        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-[1.35fr_0.85fr] lg:items-start">
          ...
          <aside className="grid gap-5">
            <div className="spabox-card p-6 sm:p-8">
              ...
              <ul className="m-0 list-none space-y-4 p-0">
                {c.directLines.map((line) => (
                  <li key={line.label}>
                    <p className="m-0 text-[12px] font-semibold uppercase text-[#9f676d]">
                      {line.label}
                    </p>
                    <a
                      href={line.href}
                      className="text-[18px] font-semibold text-[#3f2046] transition-colors hover:text-[#9f676d]"
                    >
                      {line.value}
                    </a>
                  </li>
            ...
            <div className="spabox-card p-6 sm:p-8">
              ...
              <p className="m-0 text-[22px] font-semibold text-[#3f2046]">{brand.contact.address}</p>
              <p className="mt-2 text-[14px] font-medium text-[#4c3052]/72">{brand.contact.hours}</p>
            </div>
          </aside>
        </div>
      </div>
