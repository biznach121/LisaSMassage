  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#4c3052]/60">
            Reference: <code className="text-[#3f2046]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#3f2046]/18 px-7 text-sm font-semibold text-[#3f2046] transition-colors hover:bg-[#ebcacc]"
          >
            Back home
          </Link>
        </div>
