...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#6c2456] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#782a64]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(70, 18, 56,0.58),rgba(92, 17, 80,0.22)_43%,rgba(72, 22, 58,0.34)),linear-gradient(0deg,rgba(37, 13, 30,0.18),rgba(37, 13, 30,0.08))]" />
