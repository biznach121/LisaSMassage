...
export function MediaGallery() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#f3e0e1] px-4 pb-24 pt-14 text-[#3f2046] sm:px-8">
      <svg
        className="pointer-events-none absolute -left-16 -top-36 z-0 h-96 w-[520px] text-[#997882]/28"
        viewBox="0 0 520 380"
        fill="none"
        aria-hidden="true"
      >
        ...
        <div className="mb-10 flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="group inline-flex h-14 items-center gap-2.5 rounded-full bg-[#3f2046] pl-7 pr-6 text-[14px] font-semibold uppercase tracking-[0.12em] text-[#feebec] shadow-[0_14px_34px_rgba(63, 32, 70,0.22)] transition-transform duration-300 hover:scale-[1.04]"
            >
              {brand.media.ctaLabel}
              <span className="grid h-7 w-7 place-items-center rounded-full bg-[#feebec]/18 transition-transform duration-300 group-hover:translate-x-0.5">
          ...
          {items.map((image) => {
            ...
            return (
              <div
                key={image.src}
                data-media-card
                className="relative aspect-[3/4] w-[80%] shrink-0 snap-start overflow-hidden rounded-[26px] bg-[#ebcacc] shadow-[0_20px_54px_rgba(63, 32, 70,0.16)] sm:w-[46%] lg:w-[calc((100%-2.5rem)/3)]"
              >
                {isVideo ? (
                  <video
                    src={image.src}
...
function CarouselButton({
  ...
  return (
    <button
      ...
      className="grid h-14 w-14 place-items-center rounded-full border border-[#3f2046]/18 bg-[#feebec] text-[#3f2046] transition-all duration-300 hover:border-[#3f2046] hover:bg-[#3f2046] hover:text-[#feebec] disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:border-[#3f2046]/18 disabled:hover:bg-[#feebec] disabled:hover:text-[#3f2046]"
    >
