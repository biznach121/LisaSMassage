        ...
        <section className="mt-8 grid gap-5">
          {policy.sections.map((s) => (
            <div key={s.heading} className="spabox-card p-6 sm:p-8">
              <h2 className="m-0 font-serif text-[30px] font-light leading-none text-[#3f2046]">
                {s.heading}
              </h2>
              {typeof s.body === "string" ? (
                ...
                <>
                  ...
                  <ul className="mt-4 space-y-2 pl-5 text-[16px] font-medium leading-relaxed text-[#4c3052]/82">
