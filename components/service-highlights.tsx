...
export function ServiceHighlights() {
  ...
  return (
    <section className="bg-[#ebcacc] px-4 py-14 text-[#3f2046] sm:px-8">
      <div className="mx-auto max-w-[1340px]">
        <h2 className="m-0 mb-10 text-center font-serif text-[42px] font-light leading-[0.92] tracking-normal text-[#3f2046] sm:text-[58px] lg:text-[72px]">
        ...
        <div className="relative">
          <button
            ...
            className="absolute left-0 top-[82px] z-10 flex h-11 w-11 -translate-x-2 items-center justify-center rounded-full bg-[#3f2046] text-[#feebec] shadow-[0_12px_32px_rgba(63, 32, 70,0.18)] transition-transform hover:scale-105 sm:-translate-x-1/2"
          >
            ...
            {highlights.map((item) => (
              ...
              >
                <span className="service-highlight-frame relative flex h-[172px] w-[172px] items-center justify-center rounded-full p-[9px] transition-transform duration-500 group-hover:-translate-y-1 group-hover:scale-[1.03] sm:h-[208px] sm:w-[208px]">
                  <span className="relative z-10 flex h-full w-full items-center justify-center rounded-full bg-[#feebec] p-[7px] shadow-[inset_0_0_0_1px_rgba(63, 32, 70,0.1)]">
                    <span className="relative block h-full w-full overflow-hidden rounded-full bg-[#e4bdc2]">
                      <Image
                        src={item.image}
                        alt={item.alt}
                        fill
                ...
                <span className="text-[18px] font-semibold leading-none text-[#3f2046]/86 sm:text-[20px]">
                  {item.label}
                </span>
              </Link>
            ))}
          ...
          <button
            ...
            className="absolute right-0 top-[82px] z-10 flex h-11 w-11 translate-x-2 items-center justify-center rounded-full bg-[#3f2046] text-[#feebec] shadow-[0_12px_32px_rgba(63, 32, 70,0.18)] transition-transform hover:scale-105 sm:translate-x-1/2"
          >
