...
export function ServicesIntro() {
  return (
    <section className="relative isolate overflow-hidden bg-[#f3e0e1] px-6 pb-12 pt-8 text-[#3f2046] sm:px-8">
      <svg
        className="pointer-events-none absolute -right-16 -top-36 z-0 h-72 w-72 text-[#997882]/28"
        viewBox="0 0 320 320"
        fill="none"
        aria-hidden="true"
      >
