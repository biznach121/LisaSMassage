...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783493484/stage4/spa_privatemassagebylisa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Private Massage by Lisa - Clean, private, professional">
        <Image
          src={src}
          alt="Private Massage by Lisa - Clean, private, professional"
          fill
