...
export const brand: Brand = {
  name: "Private Massage by Lisa",
  shortName: "Lisa's Massage",
  microTag: "CLEAN, PRIVATE, PROFESSIONAL",
  description:
    "Private Massage by Lisa is a Accra massage studio built around one promise: you leave lighter than you came.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0206063506",
    phoneTel: "+233206063506",
    textPhone: "0206063506",
    textPhoneTel: "+233206063506",
    email: "hello@lisasmassage.test",
    privacyEmail: "privacy@lisasmassage.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@privatemassage_bylisa", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Private Massage by Lisa was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Private Massage by Lisa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Private Massage by Lisa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Private Massage by Lisa beauty ritual",
      ...
      },
      {
        ...
        alt: "Private Massage by Lisa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Private Massage by Lisa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Private Massage by Lisa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Private Massage by Lisa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Private Massage by Lisa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Private Massage by Lisa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Private Massage by Lisa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@privatemassage_bylisa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783493497/stage4/spa_privatemassagebylisa/tiktok_0.mp4",
        alt: "Private Massage by Lisa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581425/w22e5ae19sjiofurtmlm.mp4",
        alt: "Private Massage by Lisa beauty media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Private Massage by Lisa salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Private Massage by Lisa self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Private Massage by Lisa studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Private Massage by Lisa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Private Massage by Lisa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0206063506 and text 0206063506 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0206063506, text 0206063506, or message @privatemassage_bylisa on Instagram." },
          ...
          { q: "Where are you located?", a: "Private Massage by Lisa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@lisasmassage.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Private Massage by Lisa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@lisasmassage.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Private Massage by Lisa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@lisasmassage.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Private Massage by Lisa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0206063506", href: "tel:+233206063506" },
      { label: "Text", value: "0206063506", href: "sms:+233206063506" },
      { label: "Instagram", value: "@privatemassage_bylisa", href: "https://www.tiktok.com/@privatemassage_bylisa" },
    ],
  },
  ...
  footer: {
    blurb:
      "Private Massage by Lisa in Accra — clean, private, professional.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@privatemassage_bylisa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0206063506", href: "tel:+233206063506" },
          { label: "Text 0206063506", href: "sms:+233206063506" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Private Massage by Lisa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
